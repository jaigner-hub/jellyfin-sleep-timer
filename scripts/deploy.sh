...
echo "==> deploy to rasp"
ssh rasp 'sudo mkdir -p /var/lib/jellyfin/plugins/SleepTimer_1.1.0.0'
scp out/Jellyfin.Plugin.SleepTimer.dll rasp:/tmp/SleepTimer.dll
ssh rasp 'sudo mv /tmp/SleepTimer.dll /var/lib/jellyfin/plugins/SleepTimer_1.1.0.0/Jellyfin.Plugin.SleepTimer.dll \
  && sudo chown -R jellyfin:jellyfin /var/lib/jellyfin/plugins/SleepTimer_1.1.0.0 \
